...
- **`-v, --verbose`**: Print diagnostics about configuration resolution.
...
- **`--version`**: Display version information for debugging purposes.
...
This allows command-line environment variables to override both `.env` and `config.ini` values.
